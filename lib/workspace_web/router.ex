defmodule WorkspaceWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {WorkspaceWeb.Layouts, :root}
  ...
  scope "/", WorkspaceWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{WorkspaceWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", WorkspaceWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{WorkspaceWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", WorkspaceWeb do
    ...
    live_session :current_user,
      on_mount: [{WorkspaceWeb.UserAuth, :mount_current_user}] do
