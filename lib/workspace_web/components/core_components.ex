        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-6 shadow-lg ring-1 transition sm:p-8"
            >
        ...
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-gray-50">
            <td
              ...
              class={["relative p-0 pl-2", @row_click && "hover:cursor-pointer"]}
            >
            ...
            <td :if={@action != []} class="relative w-14 pr-2">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                <span class="absolute -inset-y-px -right-4 left-0 group sm:rounded-r-xl" />
                <span
                  :for={action <- @action}
